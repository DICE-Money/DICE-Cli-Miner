...
if "%choice%"=="1" (
	...
	goto:diceVal
     ...
     node index.js -v ./out/unitTest.txt.1
) else if "%choice%"=="4" (
    ...
    node index.js -cCuda miner.json ./out/unitTest.txt 3SEdktQGS4K947PUadvbHFD2oJG
) else (
...
:diceVal
node index.js -c miner.json ./out/unitTest.txt 3SEdktQGS4K947PUadvbHFD2oJG %value%
goto:choosing
